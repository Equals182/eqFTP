...
Ftp.prototype.raw = function(params) {
    ...
    */
    ...
    console.log('[eqFTP-rawTest] Command string: ', commandString);

    console.log('[eqFTP-rawTest] Pushing to queue: ', {command: commandString, callback: params.callback, callback100: params.callback100});
...
Ftp.prototype.doQueue = function() {
    if (this.commandQueue.length > 0) {
        ...
        console.log('[eqFTP-rawTest] doQueue. Command is: ', command);
