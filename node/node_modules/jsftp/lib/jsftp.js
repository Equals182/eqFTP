...
Ftp.prototype._createSocket = function(port, host, firstAction) {
  ...
  socket.on("error", function(err) {
      console.error("[eqFTP] Can't connect to server. Check your firewall settings for node.exe file, save all your files that opened in Brackets and press F5 to refresh Brackets.");
      var index = module.parent;
      index.parent.parent.exports.emitEvent("bracketsftp", "connectError", err)
  });
