...
exports.compile = function (content) {
    ...
    return {
        accepts: function (input) {
            //This should return if file is accepted. By default you're writing paths that are not accapted to this one should check if path doesn't matches any of rule.
            if (input[0] === '/') input = input.slice(1);
            var positive = (positives[0] != "/^(())/") ? positives[0].test(input) : false;
            var negative = (negatives[0] != "/^(())/") ? negatives[0].test(input) : false;
