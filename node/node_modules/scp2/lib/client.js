...
Client.prototype.raw = function(params) {
    var self = this,
        cmd = params.command + (params.arguments?(" " + params.arguments.join(" ")):"");
    self.__ssh.exec(cmd, {pty: false}, function(err, stream) {
        if (err) {
            if (typeof params.callback === "function")
                params.callback(err, {text: stream});
        } else {
            var data = "",
                err = "";
