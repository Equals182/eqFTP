define({
	...
	"ERR_DIAG_AUTHORIZEERR_CONTENT" : "Ik kan niet inloggen met de gegevens.<br>Controleer ze eens, wil je?",
	"ERR_DIAG_NOSERVERFOUND_TITLE" : "Kon verbinding niet vinden",
	"ERR_DIAG_NOSERVERFOUND_CONTENT" : "Er zijn geeneqFTP verbindingen/server gekoppeld aan dit project.<br>Verbind met de server of stel de momentele projectlocatie in als lokale path voor dit project.",
	"ERR_DIAG_ECONNRESET_TITLE" : "Server staat geen verbindingen toe.",
	"ERR_DIAG_ECONNRESET_CONTENT" : "Ik kan niet verbinden met de server. Hij sluit me uit.<br>Probeer Brackets eens te herstarten.",
	...
	"SETTINGSWIND_ERR_CANTWRITE" : "Iets liep totaal mis! Ik kon uw instellingen niet schrijven naar een bestand.",
	"SETTINGSWIND_ERR_LOCALPATHREPEAT" : "Het path die u ingeeft wordt momenteel gebruikt door een andere verbinding.",
	...
	"SETTINGSWIND_NOTHINGYETMSG" : "Kies verbinding om te bewerken in de zijbalk, of maak een nieuwe.",
	...
	"SETTINGSWIND_GLOB_LOCALPATH_FILLWPROJECT_TITLE" : "Voer het momentele path van uw project in",
	...
	"SETTINGSWIND_GLOB_TIMEFORMAT_EU" : "Europeaans",
